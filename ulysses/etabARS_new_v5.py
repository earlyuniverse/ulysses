...
class EtaB_ARS(ulysses.ULSBase):
    ...
    def EtaB(self):
        ...
        S1_t = 0.00735/(Tew*Tew) #S1_M_fun(self.M2, 1.)
        ...
        zosc = np.cbrt(12.*Tew**3/(dMval * dMval * M0))
...
class EtaB_ARS_INTERP(EtaB_ARS):
    ...
    def __init__(self, *args, **kwargs):
        ...
        M1_f  = os.path.join(data_dir, "./data/Log_M.txt")
        ...
        M1tab  = np.loadtxt(M1_f, skiprows=0)
        ...
        self.S0MInt_ = RectBivariateSpline(M1tab, z2tab, S0Mtab) # 2-D Interpolation
        self.S1MInt_ = RectBivariateSpline(M1tab, z2tab, S1Mtab) # 2-D Interpolation
