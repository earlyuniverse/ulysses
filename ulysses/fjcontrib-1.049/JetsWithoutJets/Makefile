...
NAME=JetsWithoutJets
SRCS=JetsWithoutJets.cc EventStorage.cc
EXAMPLES=example_basic_usage example_advanced_usage
INSTALLED_HEADERS=JetsWithoutJets.hh EventStorage.hh
#------------------------------------------------------------------------
...
JetsWithoutJets.o: JetsWithoutJets.hh EventStorage.hh
EventStorage.o: EventStorage.hh
example_basic_usage.o: JetsWithoutJets.hh EventStorage.hh
example_advanced_usage.o: JetsWithoutJets.hh EventStorage.hh
