...
const char *gengetopt_args_info_usage = "Usage: convert_example [OPTION]... [inputfile outputfile]...";
...
const char *cmdline_parser_input_format_values[] = {"hepmc2", "auto", "hepmc3", "hpe", "root", "treeroot", "lhef", "gz","uproot", "plugin", 0}; /*< Possible values for input-format. */
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hi:o:e:", long_options, &option_index);
