# non-resonant leptogenesis with three decaying sterile neutrino using the density matrix equations. Equations from 1112.4528 including the scattering term from 0401240
import leptomts
import numpy as np
...
class EtaB_3DME_Scattering(leptomts.LeptoCalc):
    """
    TODO add docstring
    """
